...
export function ClassicLoader({
  ...
  const transformOriginXMap = {
    sm: "0.75px",
    md: "1px",
    lg: "1.25px",
  };

  const transformOriginYMap = {
    sm: "10px",
    md: "12px",
    lg: "14px",
  };
      ...
      <div className="absolute h-full w-full">
        {[new Array(12)].map((_, i) => (
          <div
            ...
            key={`spinner-fade-${i.toString()}`}
            style={{
              top: "0",
              left: "50%",
              marginLeft: marginLeftMap[size],
              transformOrigin: `${transformOriginXMap[size]} ${transformOriginYMap[size]}`,
